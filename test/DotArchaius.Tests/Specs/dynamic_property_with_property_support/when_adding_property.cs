...
{
    [TestFixture]
    public class when_adding_property : DynamicPropertyWithPropertySupportTest
    {
        ...
        protected override void Setup()
        {
            ...
            DynamicPropertySupport.PropertyEventListener.OnAddingProperty(PropertySource, PropertyOneName, null);
        }
